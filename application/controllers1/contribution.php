...
class Contribution extends CI_Controller {
    ...
    function contribution_transaction() {
        ...
        $config["total_rows"] = $this->contribution_model->count_transaction($key, $from, $upto);
        $config["uri_segment"] = 4;
        ...
        $this->data['transactionlist'] = $this->contribution_model->search_transaction($key, $from, $upto, $config["per_page"], $page);
