...
$lang['journalentry_link_entity'] ='Customer / Supplier / Loan / CBU';
...
$lang['journalentry_link_help'] ='Optional: link a line to a Customer, Supplier, Loan, or CBU Account so it appears on that sub-ledger after posting. For Capital Build Up, select the CBU Chart of Account then Link To → CBU Account. On approval, CBU-linked lines also update the member CBU balance/statement. Customer/Supplier/Loan links do not update invoice or loan schedules — use those modules for operational payments.';
