...
class Report_Model extends CI_Model {
    ...
    function create_ledger_trans_summary($from, $until) {
        ...
        foreach ($account_type as $key => $value) {
            $account_list = $this->finance_model->account_chart(null, null, $value->id)->result();
...
FROM  
  contribution_transaction WHERE member_id='$member_id' AND createdon>='$fromdate 00:00:00' AND createdon <= '$until 23:59:59'  ORDER BY createdon ASC";
...
FROM  
  share_transaction WHERE member_id='$member_id' AND createdon>='$fromdate 00:00:00' AND createdon <= '$until 23:59:59'  ORDER BY createdon ASC";
