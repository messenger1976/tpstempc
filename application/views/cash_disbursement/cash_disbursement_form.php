        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5><?php echo lang('cash_disbursement_create'); ?></h5>
                ...
                <div class="ibox-content">
                                ...
                                <div class="col-lg-8">
                                    <div class="input-group date" id="datetimepicker">
                                        <input type="text" name="disburse_date" placeholder="<?php echo lang('hint_date'); ?>" 
                                               value="<?php echo set_value('disburse_date', date('d-m-Y')); ?>" 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <div class="input-group">
                                        <input type="text" name="paid_to" id="paid_to" value="<?php echo set_value('paid_to'); ?>" class="form-control" required/>
                    ...
                    <div class="table-responsive">
                        <table id="lineItemsTable" class="table table-bordered">
                            <thead>
                                <tr>
                                    <th style="width: 40%;"><?php echo lang('cash_disbursement_account'); ?> <span class="required">*</span></th>
                                    <th style="width: 40%;"><?php echo lang('cash_disbursement_line_description'); ?></th>
                                    <th style="width: 15%;"><?php echo lang('cash_disbursement_amount'); ?> <span class="required">*</span></th>
                                    <th style="width: 5%;"></th>
                                </tr>
                            </thead>
                            <tbody>
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                            ...
                            <a href="<?php echo site_url(current_lang() . '/cash_disbursement/cash_disbursement_list'); ?>" class="btn btn-white">
...
(function(){
    ...
    function initOnceReady(){
        ...
        var $ = window.jQuery;
        function boot(){
            // Use same datepicker as cash receipt: standard bootstrap-datepicker (not datetimepicker)
