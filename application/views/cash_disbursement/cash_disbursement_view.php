        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5><?php echo lang('cash_disbursement_view'); ?> - <?php echo $disburse->disburse_no; ?>
                    ...
                    <div class="ibox-tools">
                        ...
                        <?php if (has_role(6, 'Journal_entry') && !empty($disburse->is_posted_to_gl) && !empty($disburse->journal_entry_id) && empty($disburse->cancelled)): ?>
