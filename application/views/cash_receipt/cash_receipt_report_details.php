...
<head>
    ...
    <style>
        ...
        .tb-table .total-row td.col-account-code,
        .tb-table .total-row td.col-account-name { text-align: right; }
...
<body>
    <div class="report-container">
        ...
        <div class="report-subtitle"><?php echo lang('cash_receipt_report_details'); ?></div>
        <div class="report-period">
            <?php if (!empty($date_from) || !empty($date_to)): ?>
                <?php echo lang('cash_receipt_period'); ?>: <?php echo !empty($date_from) ? date('d-m-Y', strtotime($date_from)) : 'Start'; ?>
            ...
            foreach ($details as $row) {
                ...
                if (!isset($grouped[$key])) {
                    $grouped[$key] = array(
                        ...
                        'receipt_description' => isset($row->receipt_description) ? $row->receipt_description : '',
                        'lines' => array()
                    );
                }
        ...
        <div class="txn-group">
            <div class="txn-header">
                <div class="txn-title"><?php echo lang('cash_receipt_no'); ?>: <?php echo htmlspecialchars($txn['receipt_no']); ?>
                    &nbsp;&nbsp;|&nbsp;&nbsp; <?php echo lang('cash_receipt_date'); ?>: <?php echo date('d-m-Y', strtotime($txn['receipt_date'])); ?>
                    &nbsp;&nbsp;|&nbsp;&nbsp; <?php echo lang('cash_receipt_received_from'); ?>: <?php echo htmlspecialchars($txn['received_from']); ?>
                    &nbsp;&nbsp;|&nbsp;&nbsp; <?php echo lang('cash_receipt_payment_method'); ?>: <?php echo htmlspecialchars($txn['payment_method']); ?>
                </div>
                <?php if (!empty($txn['receipt_description'])): ?>
                    <div class="txn-meta"><?php echo lang('cash_receipt_description'); ?>: <?php echo htmlspecialchars($txn['receipt_description']); ?></div>
                <?php endif; ?>
            </div>
            <table class="tb-table table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="col-credit"><?php echo number_format($l->amount, 2); ?></td>
                    </tr>
                    <?php endforeach; ?>
                    <tr class="total-row">
        ...
        <?php
            endforeach;
        ?>
        <div class="grand-total"><?php echo lang('total'); ?> (<?php echo count($grouped); ?> <?php echo lang('cash_receipt_transactions'); ?>): <?php echo number_format($report_grand_total, 2); ?></div>
        <?php
        } else {
        ...
        <div class="no-print">
            ...
            <?php
            $export_url = site_url(current_lang() . '/cash_receipt/cash_receipt_report_details_export');
