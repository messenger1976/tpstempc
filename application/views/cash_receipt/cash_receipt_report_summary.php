...
<body>
    <div class="report-container">
        ...
        <div class="report-subtitle"><?php echo lang('cash_receipt_report_summary'); ?></div>
        ...
        <div class="no-print">
            ...
            <?php
            $export_url = site_url(current_lang() . '/cash_receipt/cash_receipt_report_summary_export');
