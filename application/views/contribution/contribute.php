        ...
        <div class="col-lg-7">
            <div class="cbu-panel">
                <div class="panel-head">
                    ...
                    <h4><?php echo lang('contribution_service'); ?></h4>
                </div>
                <div class="panel-body">
                    ...
                    <div class="section-divider">
                        <i class="fa fa-exchange"></i><?php echo lang('contribution_payment'); ?>
                    </div>
                    ...
                    <div class="form-group cbu-actions">
                        ...
                        <div class="col-lg-7">
                            <a href="<?php echo site_url(current_lang() . '/contribution/contribution_payment'); ?>" class="btn btn-default">
        ...
        <div class="col-lg-5">
            <div class="cbu-preview" id="member_info">
                <div class="cbu-preview-empty">
                    ...
                    Search a member by PID or Member ID to view details and CBU balance.
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    (function() {
        ...
        var SEARCH_URL = '<?php echo site_url(current_lang() . '/saving/search_member_contribution/'); ?>';
        ...
        function renderMemberCard(userdata, contact, balance) {
            contact = contact || {};
            ...
            output += '</ul>';
            output += '<div class="cbu-balance"><span class="lbl"><?php echo lang('balance'); ?></span><span class="val">' + escapeHtml(addCommas(balance)) + '</span></div>';
            output += '</div>';
        ...
        function loadMember(value, column, emptyAlert) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    renderMemberCard(userdata, contact, json['balance']);
                },
