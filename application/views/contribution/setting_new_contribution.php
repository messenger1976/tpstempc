...
.cbu-setting-page { margin-top: 4px; }
.cbu-setting-page .cbu-alert {
    display: block;
    margin: 0 0 16px;
    padding: 10px 14px;
    border-radius: 6px;
...
.cbu-setting-page .cbu-alert.success {
    background: #e8f8f5;
    color: #0e7c69;
    border: 1px solid #c9ebe3;
}
.cbu-setting-page .cbu-alert.danger {
    background: #fdeceb;
    color: #c0392b;
    border: 1px solid #f5c6cb;
}
.cbu-setting-page .cbu-panel {
    background: #fff;
...
.cbu-setting-page .cbu-panel .panel-head {
    display: flex;
    align-items: center;
    gap: 10px;
    padding: 14px 20px;
...
.cbu-setting-page .cbu-panel .panel-head i {
    width: 30px;
    height: 30px;
    border-radius: 50%;
    background: #e8f8f5;
...
.cbu-setting-page .cbu-panel .panel-head h4 {
    margin: 0;
    font-size: 15px;
    font-weight: 700;
    color: #2f4050;
}
.cbu-setting-page .cbu-panel .panel-body { padding: 22px 20px 12px; overflow: visible; }
.cbu-setting-page .form-horizontal .form-group { margin-bottom: 16px; }
.cbu-setting-page .form-horizontal .control-label {
    color: #676a6c;
    font-weight: 600;
    padding-top: 9px;
}
.cbu-setting-page .form-control {
    border-radius: 6px;
    border-color: #e5e6e7;
    box-shadow: none;
    height: 36px;
}
.cbu-setting-page .form-control:focus {
    border-color: #1ab394;
    box-shadow: 0 0 0 2px rgba(26,179,148,0.15);
}
.cbu-setting-page .input-group-addon {
    background: #f8fafb;
    cursor: pointer;
}
.cbu-setting-page .input-group-addon:hover { color: #1ab394; }
.cbu-setting-page .required { color: #ed5565; }
.cbu-setting-page .section-divider {
    margin: 8px 0 18px;
    padding: 10px 0 8px;
...
.cbu-setting-page .section-divider i { margin-right: 6px; }
.cbu-setting-page .cbu-actions {
    margin-top: 8px;
    margin-bottom: 8px;
    padding-top: 12px;
    border-top: 1px solid #f0f2f3;
}
.cbu-setting-page .cbu-actions .btn {
    min-width: 140px;
    padding: 9px 20px;
    border-radius: 6px;
    font-weight: 600;
...
.cbu-setting-page .cbu-actions .btn-default {
    background: #fff;
    border: 1px solid #e1e5e8;
    color: #676a6c;
}
.cbu-setting-page .cbu-actions .btn-default:hover {
    background: #f8fafb;
    border-color: #c5c9cc;
    color: #2f4050;
}
.cbu-setting-page .cbu-actions .btn-primary {
    box-shadow: 0 2px 6px rgba(26,179,148,0.25);
}
.cbu-setting-page .cbu-lookup { position: relative; }
.cbu-setting-page .member-suggest-box {
    display: none;
    position: absolute;
    left: 0;
    right: 0;
...
.cbu-setting-page .member-suggest-box.open { display: block; }
.cbu-setting-page .member-suggest-item {
    display: flex;
    align-items: center;
    gap: 10px;
    width: 100%;
...
.cbu-setting-page .member-suggest-item:last-child { border-bottom: 0; }
.cbu-setting-page .member-suggest-item:hover,
.cbu-setting-page .member-suggest-item.active {
    background: #e8f8f5;
}
.cbu-setting-page .member-suggest-item .suggest-id {
...
.cbu-setting-page .member-suggest-item .suggest-name {
    flex: 1;
    font-weight: 600;
    color: #2f4050;
    font-size: 13px;
}
.cbu-setting-page .member-suggest-item .suggest-status {
    color: #999;
    font-size: 11px;
    font-weight: 600;
    white-space: nowrap;
}
.cbu-setting-page .member-suggest-empty {
    padding: 12px;
    color: #999;
    font-size: 12px;
}
.cbu-setting-page .cbu-preview {
...
.cbu-setting-page .cbu-preview-empty {
    text-align: center;
    color: #999;
    padding: 40px 12px;
}
.cbu-setting-page .cbu-preview-empty i {
    font-size: 42px;
    color: #c9ebe3;
    display: block;
    margin-bottom: 12px;
}
.cbu-setting-page .cbu-member-card { text-align: center; }
.cbu-setting-page .cbu-member-photo {
    width: 120px;
    height: 120px;
    margin: 0 auto 14px;
    border-radius: 50%;
...
.cbu-setting-page .cbu-member-photo img {
    width: 100% !important;
...
.cbu-setting-page .cbu-member-photo.avatar-fallback img {
    object-fit: contain;
    object-position: center center;
    background: #e8f8f5;
}
.cbu-setting-page .cbu-badge.inactive {
    background: #fdeceb;
    color: #c0392b;
}
.cbu-setting-page .cbu-member-photo-empty {
    display: flex;
    align-items: center;
    justify-content: center;
    background: #e8f8f5;
}
.cbu-setting-page .cbu-member-photo-empty i {
    font-size: 42px;
    color: #1ab394;
}
.cbu-setting-page .cbu-member-name {
    margin: 0 0 6px;
    font-size: 17px;
    font-weight: 700;
    color: #2f4050;
...
.cbu-setting-page .cbu-member-badges {
    display: flex;
    flex-wrap: wrap;
    gap: 6px;
    justify-content: center;
...
.cbu-setting-page .cbu-member-details {
    text-align: left;
    margin: 0;
    padding: 0;
    list-style: none;
...
.cbu-setting-page .cbu-member-details li {
    display: flex;
...
.cbu-setting-page .cbu-member-details li:last-child { border-bottom: 0; }
.cbu-setting-page .cbu-member-details .lbl { color: #999; font-weight: 500; }
.cbu-setting-page .cbu-member-details .val {
    color: #2f4050;
    font-weight: 600;
    text-align: right;
    word-break: break-word;
}
.cbu-setting-page .bootstrap-datetimepicker-widget { z-index: 1060 !important; }
</style>

<?php echo form_open_multipart(current_lang() . "/contribution/contribute_setting_create/" . $id, 'class="form-horizontal"'); ?>

<div class="col-lg-12 cbu-setting-page">
    <?php
        ...
        <div class="col-lg-7">
            <div class="cbu-panel">
                <div class="panel-head">
                    <i class="fa fa-cog"></i>
                    <h4><?php echo lang('contribution_setting_create'); ?></h4>
                </div>
                <div class="panel-body">
                        ...
                        <div class="col-lg-7">
                            <div class="cbu-lookup">
                                <div class="input-group">
                                    <input type="text" id="pid" name="pid" value="<?php echo (isset($contr) ? $contr->PID : set_value('pid')); ?>" class="form-control" autocomplete="off"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                            <div class="cbu-lookup">
                                <div class="input-group">
                                    <input type="text" id="member_id" name="member_id" value="<?php echo (isset($contr) ? $contr->member_id : set_value('member_id')); ?>" class="form-control" autocomplete="off"/>
                    ...
                    <div class="section-divider">
                        <i class="fa fa-money"></i><?php echo lang('contribution_setting_title'); ?>
                    </div>

                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?php echo lang('document_date'); ?> : <span class="required">*</span></label>
                        <div class="col-lg-7">
                            <div class="input-group date" id="datetimepicker">
                                <?php $posting_date = (isset($contr) ? date("d-m-Y", strtotime($contr->posting_date)) : set_value('posting_date', date('d-m-Y'))); ?>
                    ...
                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?php echo lang('contribution_source'); ?> : <span class="required">*</span></label>
                        <div class="col-lg-7">
                            <select name="contribution_source" class="form-control">
                                <option value=""><?php echo lang('select_default_text'); ?></option>
                                <?php
                                $selected = (isset($contr) ? $contr->contribute_source : set_value('contribution_source'));
                                foreach ($contribution_source_list as $key => $value) {
                                    ?>
                                    <option <?php echo ($value->id == $selected ? 'selected="selected"' : ''); ?> value="<?php echo $value->id; ?>"><?php echo $value->name; ?></option>
                                <?php } ?>
                            </select>
                            <?php echo form_error('contribution_source'); ?>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-lg-4 control-label"><?php echo lang('contribution_amount'); ?> : <span class="required">*</span></label>
                        <div class="col-lg-7">
                            <input type="text" name="open_balance" value="<?php echo (isset($contr) ? $contr->amount : set_value('open_balance')); ?>" class="form-control amountformat"/>
...
<script type="text/javascript">
    (function() {
        ...
        $('#cancel_button').click(function(e) {
            e.preventDefault();
            window.location.href = '<?php echo site_url(current_lang() . '/contribution/contribute_setting'); ?>';
        });
        ...
        var pid = $.trim('<?php echo (isset($contr) ? $contr->PID : set_value('pid')); ?>');
        if (pid !== '') {
            loadMember(pid, 'PID');
        }
