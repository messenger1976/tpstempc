...
<?php
$is_edit = !is_null($id);
$form_url = $is_edit ? current_lang() . '/finance/chart_type_edit/' . $id : current_lang() . '/finance/chart_type_create';
$list_url = site_url(current_lang() . '/finance/chart_type_list');
$account_value = set_value('account', isset($chart_type) ? $chart_type->account : '');
$name_value = set_value('name', isset($chart_type) ? $chart_type->name : '');
?>
    ...
    <div class="cbu-panel">
        <div class="panel-head">
            <div class="head-left">
                ...
                <h4><?php echo $is_edit ? lang('chart_type_edit') : lang('chart_type_create'); ?></h4>
            </div>
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-lg-6">
                    <input type="text" name="account" value="<?php echo htmlspecialchars($account_value, ENT_QUOTES, 'UTF-8'); ?>" class="form-control" required/>
