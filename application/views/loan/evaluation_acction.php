...
$status_options = array(
    '1' => 'Evaluated & Accepted',
    '3' => 'Evaluated & Need some information',
...
<div class="col-lg-12 loan-eval-page">
    ...
    <div class="cbu-panel">
        <div class="panel-head">
            ...
            <?php if ($can_edit) { ?>
                <a class="btn btn-primary btn-sm btn-edit-loan" href="<?php echo site_url(current_lang() . '/loan/loan_editing/' . $loanid); ?>">
                    <i class="fa fa-edit"></i> <?php echo lang('loan_edit'); ?>
                </a>
            <?php } ?>
        </div>
        <div class="panel-body">
