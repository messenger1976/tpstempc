...
<div class="col-lg-12 member-list-page">
    ...
    <div class="member-filter-panel">
        <div class="panel-head">
            <div class="panel-head-left">
                ...
                <h4><?php echo lang('loan_approval_list'); ?></h4>
            </div>
        </div>
        <div class="panel-body">
            <form action="<?php echo site_url(current_lang() . "/loan/loan_approval"); ?>" method="get" class="form-horizontal">
                <div class="filter-row">
                    ...
                    <div class="filter-actions">
                        <a href="<?php echo site_url(current_lang() . '/loan/loan_approval'); ?>" class="btn btn-default btn-clear-filter">
    ...
    <div class="member-table-panel">
        <div class="panel-head">
            <div class="panel-head-left">
                <i class="fa fa-thumbs-o-up icon-badge"></i>
                <h4><?php echo lang('loan_approval_list'); ?></h4>
            </div>
            <?php
                ...
                <tbody>
                    <?php if (!empty($loan_wait)) { ?>
                        <?php foreach ($loan_wait as $value) {
                            ...
                            $status_name = !empty($value->status_name) ? $value->status_name : 'Evaluated & Accepted';
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-btns">
                                        <?php echo anchor(current_lang() . "/loan/loan_approval_action/" . encode_id($value->LID), ' <i class="fa fa-thumbs-o-up"></i> ' . lang('loan_approval_link'), 'class="btn btn-primary btn-xs"'); ?>
                                    </div>
                                </td>
                            </tr>
                        <?php } ?>
