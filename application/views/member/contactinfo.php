...
<div style="margin-top: 20px;" class="col-lg-12">
    ...
    <div class="col-lg-8">
        ...
        <div class="form-group"><label class="col-lg-3 control-label"><?php echo lang('member_contact_phone1'); ?>  : <span class="required">*</span></label>
            <div class="col-lg-6">
                <div class="input-group"><span class="input-group-addon" style="border: 0px; padding: 0px 5px 0px 0px; margin: 0px"> <select name="pre_phone1" style="background: transparent; padding: 7px;  border:  1px solid #E5E6E7">
                            ...
                            <?php } ?>
                        </select> </span><input type="text" name="phone1" value="<?php echo substr($contactinfo->phone1, -10); ?>"  class="form-control"/> </div>
        ...
        <div class="form-group"><label class="col-lg-3 control-label"><?php echo lang('member_contact_tinno'); ?>  : </label>
            <div class="col-lg-6">
                <input type="text" name="tinno" value="<?php echo $contactinfo->tinno; ?>"  class="form-control"/> 
                <?php echo form_error('tinno'); ?>
            </div>
        </div>
        <div class="form-group"><label class="col-lg-3 control-label"><?php echo lang('member_contact_sssno'); ?>  : </label>
            <div class="col-lg-6">
        ...
        <div class="form-group"><label class="col-lg-3 control-label"><?php echo lang('member_remarks'); ?>  : </label>
            <div class="col-lg-6">
                <input type="text" name="box" value="<?php echo $contactinfo->postaladdress; ?>"  class="form-control"/> 
                <?php echo form_error('box'); ?>
            </div>
