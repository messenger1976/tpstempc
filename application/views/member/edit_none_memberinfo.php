<?php
$this->load->view('member/topmenu_none_member');
?>
...
<div class="form-group"><label class="col-lg-3 control-label"><?php echo lang('member_none_member_id'); ?>  : </label>
    <div class="col-lg-6">
        <input type="text" name="memberid" value="<?php echo $basicinfo->member_id; ?>"  class="form-control"/> 
...
<div class="form-group"><label class="col-lg-3 control-label"><?php echo lang('member_reg_date'); ?>  : <span class="required">*</span></label>
    <div class=" col-lg-6">
