...
<?php echo form_open_multipart(current_lang() . "/mortuary/mortuary_payment", 'class="form-horizontal"'); ?>
...
<div class="col-lg-12">
    <div class="col-lg-7">
        ...
        <div style="color: brown;margin: 20px; font-weight: bold; font-size: 13px; border-bottom: 1px solid #ccc;">
            <?php echo lang('mortuary_fund_info'); ?>
        </div>     
        ...
        <div class="form-group"><label class="col-lg-4 control-label"><?php echo lang('mortuary_transaction_date'); ?>  : <span class="required">*</span></label>
            <div class=" col-lg-7">
                <div class="input-group date" id="datetimepicker" >
                    <input type="text" name="trans_date" placeholder="<?php echo lang('hint_date'); ?>" value="<?php echo set_value('trans_date'); ?>"  data-date-format="DD-MM-YYYY" class="form-control"/> 
        ...
        <div class="form-group"><label class="col-lg-4 control-label"><?php echo lang('transaction_type'); ?>  : <span class="required">*</span></label>
            <div class="col-lg-7">
                <select name="trans_type" class="form-control">
                    ...
                    $transtype = lang('mortuary_payment_option');
