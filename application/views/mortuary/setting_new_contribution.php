...
<?php echo form_open_multipart(current_lang() . "/mortuary/mortuary_setting_create/".$id, 'class="form-horizontal"'); ?>
...
<div class="col-lg-12">
    <div class="col-lg-7">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-6">
                <a href="<?php echo base_url(current_lang().'/mortuary/mortuary_master_list');?>" class="btn btn-default">Back</a>
