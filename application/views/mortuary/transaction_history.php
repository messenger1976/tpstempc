...
<?php echo form_open(current_lang() . "/mortuary/mortuary_transaction", 'class="form-horizontal"'); ?>
           ...
           $index++;
            foreach ($transactionlist as $key => $value) {
                ...
                <tr>
                    ...
                    <td><?php echo anchor(current_lang() . "/mortuary/receipt_view/" . $value->receipt, ' <i class="fa fa-edit"></i> ' . lang('view_link')); ?></td>
                </tr>
            <?php } ?>
        </tbody>
