            ...
            if (access_module(1)) {
                ...
                <li class="<?php echo ($active == 'member' ? 'active' : ''); ?>">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <?php } ?>
                        <?php if (has_role(1, 'Register_none_member')) { ?>
                            <li class="<?php echo ($activefunction == 'none_member' ? 'active' : ''); ?>"><a href="<?php echo site_url(current_lang() . '/member/none_member'); ?>"><?php echo lang('member_none_registration'); ?></a></li>
                        <?php } ?>
            ...
            <?php if (access_module(5)) { ?>
                <li class="<?php echo (($active == 'loan' || $active == 'cic') ? 'active' : ''); ?>">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <?php } ?>
                        <?php if (has_role(5, 'Loan_waiver_approval') || (function_exists('can_approve_waivers') && can_approve_waivers())) { ?>
            ...
            <?php if (access_module(6)) { ?>
                ...
                <li class="<?php echo (($active == 'finance' || $active == 'customer' || $active == 'supplier' || $active == 'cash_receipt' || $active == 'cash_disbursement' || $active == 'ar') ? 'active' : ''); ?>">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <?php } ?>
                        <?php /* Accounts Receivable - carried over from the old menu.php so nothing is
                                 lost. NOTE: the 'View_AR' permission does not exist in the role or
                                 access_level tables, so this renders for nobody today. */ ?>
                ...
                <li class="<?php echo (($active == 'setting' || $active == 'backup' || $active == 'activity_log') ? 'active' : ''); ?>">
                    ...
                    <ul class="nav nav-second-level">
                      <!--<li class="<?php echo ($activefunction == 'client_account' ? 'active' : ''); ?>"><a href="<?php echo site_url(current_lang() . '/setting/client_account');         ?>"><?php echo lang('setting_addaccount');         ?></a></li>
                        ...
                        <?php } ?>
                        <?php /* Carried over from the old menu.php (it was dashboard-only before). */ ?>
