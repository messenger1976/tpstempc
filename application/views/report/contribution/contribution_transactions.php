    ...
    <div class="col-lg-12">
        <div style=" padding: 30px 10px; margin: auto;">
            <div style="text-align: center;"> <h3><strong><?php echo company_info()->name; ?></strong></h3>
                <h1><strong>Member CBU Transactions</strong></h1>
            ...
            <div style="padding-top: 20px;">
                ...
                <div class="table-responsive" style="overflow: auto;">
                 ...
                 <div style="text-align: center">
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp;
                    <a href="<?php echo site_url(current_lang() . '/report_contribution/contribution_transaction_export/' . $link_cat . '/' . $id); ?>" class="btn btn-success">Export to Excel</a>
                    &nbsp; &nbsp; &nbsp; &nbsp;
