...
<div style="padding:0; margin:0;">
    <table style="width:100%; margin:0 0 6px 0; border-collapse:collapse;">
        <tr>
            ...
            <td style="text-align:center; vertical-align:middle; padding:0 6px;">
                ...
                <div style="font-weight:bold; font-size:13px; margin-top:4px;">MEMBER CBU TRANSACTIONS SUMMARY</div>
    ...
    <table style="width:100%; border-collapse:collapse; font-size:9px;">
        ...
        if (empty($transaction)) {
            ?>
            <tr>
                <td colspan="7" style="text-align:center; padding:12px; font-style:italic;">
