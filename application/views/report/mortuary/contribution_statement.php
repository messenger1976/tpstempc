        ...
        <div style=" padding: 30px 10px; margin: auto;">
            ...
            <div style="padding-top: 20px;">
                ...
                <div class="table-responsive" style="overflow: auto;">
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                            $balance = 0;
                            $previous_trans = $this->report_model->mortuary_statement_previous($reportinfo->fromdate, $reportinfo->description);
                            if ($previous_trans) {
                ...
                <div style="text-align: center">
                    <a href="<?php echo site_url(current_lang() . '/report_mortuary/contribution_statement_print/' . $link_cat . '/' . $id); ?>" class="btn btn-primary">Print</a>
                    &nbsp; &nbsp; &nbsp; &nbsp;
