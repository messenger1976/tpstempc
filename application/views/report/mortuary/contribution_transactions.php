    ...
    <div class="col-lg-12">
        <div style=" padding: 30px 10px; margin: auto;">
            <div style="text-align: center;"> <h3><strong><?php echo company_info()->name; ?></strong></h3>
                <h1><strong>Member Mortuary Transactions</strong></h1>
            ...
            <div style="padding-top: 20px;">
                ...
                <div class="table-responsive" style="overflow: auto;">
                 ...
                 <div style="text-align: center">
                    <a href="<?php echo site_url(current_lang() . '/report_mortuary/contribution_transaction_print/' . $link_cat . '/' . $id); ?>" class="btn btn-primary">Print</a>
                    &nbsp; &nbsp; &nbsp; &nbsp;
