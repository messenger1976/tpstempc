    ...
    <div class="col-lg-12">
        <div style=" padding: 30px 10px; margin: auto;">
            <div style="text-align: center;"> <h3><strong><?php echo company_info()->name; ?></strong></h3>
                <h1><strong>Member Mortuary Transactions Summary</strong></h1>
            ...
            <div style="padding-top: 20px;">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            foreach ($transaction as $key => $value) {
                                $balance_open = $this->report_model->mortuary_transactions_summary_previous($reportinfo->fromdate, $value->member_id);
                ...
                <div style="text-align: center">
                    <a href="<?php echo site_url(current_lang() . '/report_mortuary/contribution_transaction_summary_print/' . $link_cat . '/' . $id); ?>" class="btn btn-primary">Print</a>
                    &nbsp; &nbsp; &nbsp; &nbsp;
                    <a href="<?php echo site_url(current_lang() . '/report_mortuary/create_contribution_report_title/' . $link_cat . '/' . $id); ?>" class="btn btn-primary">Edit</a>
                </div>
            </div>
        </div>
    </div>
