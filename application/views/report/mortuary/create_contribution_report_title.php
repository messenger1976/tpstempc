...
<div class="form-group"><label class="col-lg-3 control-label"><?php echo 'Status'; ?>  : <span class="required">*</span></label>
    <div class=" col-lg-6">
        <select name="status" class="form-control">
            ...
            foreach ($mortuary_status_list as $key => $value) {
                ?>
                <option <?php echo ($reportinfo->status == $value->id ? 'selected="selected"' : ''); ?> value="<?php echo $value->id ?>"><?php echo $value->description ; ?></option>
            <?php } ?>
        </select>
