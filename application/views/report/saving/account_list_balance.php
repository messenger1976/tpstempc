                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th>Account Name</th>  
                                <th>Account Type</th>  
                                <th style="width: 150px; text-align: center;">Available Balance</th>  
                                <th style="width: 150px; text-align: center;">Actual Balance</th>  
                        ...
                        <tbody>
                            ...
                            foreach ($transaction as $key => $value) {
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;"><?php echo anchor(current_lang() . "/report_saving/new_saving_account_statement_view/". $link_cat . '/'. $id . '/' . encode_id($value->account), ' <i class="fa fa-th-list"></i> Ledger',' class="btn btn-success btn-xs btn-outline" target="_blank"'); ?></td>

                                </tr> 
                            <?php } ?>
                            <tr>
                                <td colspan="5" style="border-top: 1px solid #000; border-bottom:  1px solid #000; "></td>
