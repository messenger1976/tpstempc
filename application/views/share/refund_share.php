        ...
        <div class="col-lg-7">
            <div class="cbu-panel">
                <div class="panel-head">
                    ...
                    <h4><?php echo lang('refund_share'); ?></h4>
                </div>
                <div class="panel-body">
                    ...
                    <div class="section-divider">
                        <i class="fa fa-exchange"></i><?php echo lang('share_refund_info_label'); ?>
                    </div>
                    ...
                    <div class="form-group cbu-actions">
                        ...
                        <div class="col-lg-7">
                            <a href="<?php echo site_url(current_lang() . '/share/refund_share'); ?>" class="btn btn-default">
        ...
        <div class="col-lg-5">
            <div class="cbu-preview" id="member_info">
                <div class="cbu-preview-empty">
                    ...
                    Search a member by PID or Member ID to view details and share balance before refunding.
                </div>
            </div>
        </div>
    </div>
