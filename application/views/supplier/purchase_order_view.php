            ...
            <table>
                <tr>
                    <td valign="top" style="border-right: 1px solid #000; padding-right: 10px;">
                        ...
                        <?php echo format_date($transaction->delivery_date,FALSE) ?>
                         <br/>
                        <br/>
...
<div style="text-align: center; border-top: 1px solid #ccc;">
    <br/>
    <a class="btn btn-info" href="<?php echo site_url(current_lang() . '/supplier/send_purchase_order/' . $quoteid); ?>"><?php echo lang('customer_email'); ?></a> &nbsp; &nbsp; &nbsp; &nbsp;
    <a class="btn btn-info" href="<?php echo site_url(current_lang() . '/supplier/print_sales_purchase_order/' . encode_id($transaction->id)) ?>"><?php echo lang('print'); ?></a> &nbsp; &nbsp; &nbsp; &nbsp;
    <!--<a class="btn btn-info"><?php echo lang('edit_btn'); ?></a> --> &nbsp; &nbsp; &nbsp; &nbsp;
    <?php if ($transaction->copy_to_invoice == 0) { ?>
        <a class="btn btn-info" href="<?php echo site_url(current_lang() . '/supplier/copytonewinvoice/' . $quoteid); ?>"><?php echo lang('copytonew_purchaseinvoice'); ?></a> &nbsp; &nbsp; &nbsp; &nbsp;
    <?php } ?>
</div>
