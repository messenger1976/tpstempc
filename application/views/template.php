...
<html>
    ...
    <head>
        ...
        <title><?php echo htmlspecialchars($company_name); ?> |  <?php echo (isset ($title) ? $title : $current_title); ?></title>
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper" class="gray-bg dashbard-1">
                ...
                <!--<div class="wrapper wrapper-content animated fadeInRight fadeInDown">-->
                <div class="wrapper wrapper-content">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins" id="ibox-main">
