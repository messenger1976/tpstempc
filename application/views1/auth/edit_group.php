...
<div class="form-group"><label class="col-lg-3 control-label"><?php echo lang('create_group_name_label'); ?>  : <span class="required">*</span></label>
    <div class="col-lg-6">
        <input type="text" name="group_name" value="<?php echo $group->name; ?>"  class="form-control"/> 
...
<div class="form-group">
    ...
    <div class="col-lg-6">
        <input type="text" name="group_description"  value="<?php echo $group->description; ?>" class="form-control"/> 
...
<div class="form-group">
    ...
    <div class="col-lg-6">
        <input class="btn btn-primary" value="<?php echo lang('edit_group_submit_btn'); ?>" type="submit"/>
    </div>
</div>
<?php echo form_close(); ?>
