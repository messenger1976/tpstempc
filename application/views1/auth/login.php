...
<html lang="en">
    ...
    <div class="block white">
        <div class="container">
            <div class="row">
                <div class="span6">
                    <h3>Welcome to SACCOS PLUS</h3>
                    <hr/>
                    <ul>
                        <li>SACCOS Plus is an end-to-end information system which enables the management of Saving and Credit cooperatives in a manner that provides seamless information flow of all  the activities and transactions.</li><br/>
                        <li>SACCOS Plus come with a wide range of financial reports which aid accurate planning, forecast and decision making</li><br/>
            ...
            <div style="border-top : 2px solid #e7eaec; text-align: center; margin-top: 20px; padding-top: 10px;">
                <div id="copyright">© 2014&nbsp; &nbsp; SACCOS PLUS . All right reserved</div>
                <div>
