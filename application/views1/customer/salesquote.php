...
<?php echo form_open_multipart(current_lang() . "/customer/customersales_quote/", 'class="form-horizontal"'); ?>
...
<div class="form-group"><label class="col-lg-3 control-label"><?php echo lang('salesquote_summary'); ?>  : </label>
    <div class="col-lg-6">
...
<div class="form-group"><label class="col-lg-3 control-label"><?php echo lang('salesquote_notes'); ?>  : </label>
    <div class="col-lg-6">
        <textarea class="form-control" name="notes"><?php echo (set_value('notes') ? set_value('notes'):  default_text_value('SALES_QUOTE_NOTE')); ?></textarea>
    </div>
</div>
