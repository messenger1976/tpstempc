    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <table>
                <tr>
                    <td valign='top'><div style="padding-left: 30px;">
                            <strong><?php echo 'Normal Maximum loan ' ?> : </strong> <?php
                            $max = $product->loan_security_contribution_times * (isset($contribution->balance) ? $contribution->balance : 0);
