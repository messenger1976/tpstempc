...
echo form_open_multipart(current_lang() . "/import/import_contribution/" , 'class="form-horizontal"'); ?>
<?php
...
<div class="form-group"><label class="col-lg-3 control-label"></label>
    <div class="col-lg-6">
        <a href="<?php echo base_url().'doc/import_member_contribution.xls' ?>">Download Templates</a>
    </div>
</div>
