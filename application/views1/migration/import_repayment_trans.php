...
echo form_open_multipart(current_lang() . "/import/import_repay_trans/" , 'class="form-horizontal"'); ?>
<?php
...
<div class="form-group"><label class="col-lg-3 control-label"></label>
    <div class="col-lg-6">
        <a href="<?php echo base_url().'doc/import_member_loan_repayment_trans.xls' ?>">Download Templates</a>
    </div>
</div>
