                    ...
                    <tr>
                        <td style="width: 50%; padding-right: 20px; vertical-align: top;">
                            ...
                            <table style="width: 96%; margin-left: 20px;">
                                <?php
                                $assets = $this->report_model->get_balance_sheet_data($reportinfo->fromdate, 1);
                                $total_asset = 0;
                        ...
                        <td style="width: 50%; padding-left:  20px; vertical-align: top;">
                            ...
                            <table style="width: 96%; margin-left: 20px;">
                                <?php
                                $liabilities = $this->report_model->get_balance_sheet_data($reportinfo->fromdate, 2);
                                $total_liabilities = 0;
                            ...
                            <table style="width: 96%; margin-left: 20px;">
                                <?php
                                $equaty = $this->report_model->get_balance_sheet_data($reportinfo->fromdate, 3);
                                $total_equaty = 0;
