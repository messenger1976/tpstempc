    ...
    <div class="col-lg-12">
        <div >
            <div style="text-align: center;"> 
                ...
                <h3 style="padding: 0px; margin: 0px;"><strong>Member Shares Statement</strong></h3>
            ...
            <div>
                ...
                <div class="table-responsive" style="overflow: auto;">
                    <table class="table" style="width: 100%;" cellspacing='0' cellpadding='0' >
                        <thead>
                            <tr>
                                ...
                                <th style="width: 70px; text-align: right; ">No. of Share Affected</th>  
                                <th style="width: 70px; text-align: right;">No. of Share Remain</th> 
                    ...
                    <div style="text-align: right; font-size: 10px; font-weight: bold;"> Amount Remain for the next transaction : <?php 
                    ...
                    <div style="text-align: right; font-size: 15px; font-weight: bold;"> Share Balance : <?php echo number_format($share_balance,2);?></div>
                    <div style="text-align: right; font-size: 15px; font-weight: bold;"> Balance : <?php echo number_format($balance,2);?></div>
                </div>
