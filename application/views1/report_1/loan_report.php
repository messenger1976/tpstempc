        ...
        <div class="panel blank-panel">
            ...
            <div class="panel-heading">
                <div class="panel-options">
                    ...
                    <ul class="nav nav-tabs">
                        <li <?php echo ($activefunction == 'loan_report' ? 'class="active"' : ''); ?>><a data-toggle="tab" href="#tab-1"><?php echo lang('loan_report') ?></a></li>
            ...
            <div class="panel-body">
                ...
                <div class="tab-content">
                    ...
                    <div id="tab-1" class="tab-pane <?php echo ($activefunction == 'loan_report' ? 'active' : ''); ?>">
                        <?php echo form_open_multipart(current_lang() . "/report/loan_report", 'class="form-horizontal"'); ?>
                        ...
                        <div class="form-group"><label class="col-lg-3 control-label"> UP TO : </label>
                            <div class=" col-lg-6">
