...
<?php echo form_open_multipart(current_lang() . "/supplier/create_purchase_invoice/", 'class="form-horizontal"'); ?>
...
<div class="form-group"><label class="col-lg-3 control-label"><?php echo lang('due_date'); ?>  : <span class="required">*</span></label>
    ...
    <div class="col-lg-6">
        <div class="input-group date" id="datetimepicker2">
            <input type="text" name="due_date" placeholder="<?php echo lang('hint_date'); ?>" value="<?php echo (isset($supplierinfo) ? format_date($supplierinfo->due_date, false) : set_value('due_date')); ?>"  data-date-format="DD-MM-YYYY" class="form-control"/> 
            <span class="input-group-addon">
                <span class="fa fa-calendar "></span>
            </span>
        </div>
...
<div class="form-group"><label class="col-lg-3 control-label"><?php echo lang('purchaseinvoice_notes'); ?>  : </label>
    <div class="col-lg-6">
