...
(function (e) {
                ...
                if (e(b.target).closest("div.dataTables_wrapper")[0] == a.table().container()) {
                    ...
                    if (k.any()) {
                        ...
                        g.isDefaultPrevented() ||
                            ((g = k.index()),
                            "row" === c ? ((c = g.row), s(b, a, d, "row", c)) : "column" === c ? ((c = k.index().column), s(b, a, d, "column", c)) : "cell" === c && ((c = k.index()), s(b, a, d, "cell", c)),
    ...
    function s(a, c, b, d, f) {
        ...
        "os" === e
            ? a.ctrlKey || a.metaKey
                ...
                : ((a = c[d + "s"]({ selected: !0 })), g && 1 === a.flatten().length ? c[d](f).deselect() : (a.deselect(), c[d](f).select()))
            : "multi+shift" == e
            ? a.shiftKey
                ? "cell" === d
                    ? v(c, f, b._select_lastCell || null)
    ...
    g.select.init = function (a) {
        ...
        if (!0 === b) (f = "os"), (i = !0);
            ...
            e.isPlainObject(b) &&
            (b.blurable !== h && (l = b.blurable), b.info !== h && (w = b.info), b.items !== h && (d = b.items), b.style !== h && ((f = b.style), (i = !0)), b.selector !== h && (k = b.selector), b.className !== h)
        )
            j = b.className;
        a.select.selector(k);
        a.select.items(d);
