            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if(json['success'].toString() == 'N'){
                        ...
                        output += '<br/><br/><div style="border-bottom:1px dashed #ccc;"><strong>'+options.balance_share+' : </strong> '+share["share"]+'</div>';
                        output += '<div style="border-bottom:1px dashed #ccc;"><strong>'+options.total_shareamount+' : </strong> '+addCommas(share["amount"])+'</div>';
                        output += '<div style="border-bottom:1px dashed #ccc;"><strong>'+options.min_share+' : </strong> '+share["min_share"]+'</div>';
                        output += '<div style="border-bottom:1px dashed #ccc;"><strong>'+options.max_share+' : </strong> '+share["max_share"]+'</div>';
                        output += '<div style="border-bottom:1px dashed #ccc;"><strong>'+options.remainshare+' : </strong> '+(parseInt(share["max_share"])- parseInt(share["share"]))+'</div>';
