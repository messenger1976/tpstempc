...
class CI_Email {
	...
	var	$smtp_host		= "helmatz.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "info@helmatechnologies.com";		// SMTP Username
	var	$smtp_pass		= "henumaria1989";		// SMTP Password
	var	$smtp_port		= 465;		// SMTP Port
	var	$smtp_timeout	        = 20;		// SMTP Timeout in seconds
