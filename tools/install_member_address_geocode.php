 ...
 *   php tools/install_member_address_geocode.php
 *   php tools/install_member_address_geocode.php --force   (re-geocode all)
 *
 * Browser: http://localhost/tapstemco/tools/install_member_address_geocode.php
 */
